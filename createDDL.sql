...
CREATE TABLE PRODUCT (ID INTEGER NOT NULL, date_permeption DATE, DESIGNATION VARCHAR(255), list_remb VARCHAR(255), prix_usine FLOAT, PU FLOAT, QUANTITY INTEGER, REFERENCE VARCHAR(255), REGLEMENT VARCHAR(255), THRESHOLDALERT INTEGER, POSOLOGIE_ID INTEGER, PRIMARY KEY (ID))
...
CREATE TABLE vente_produit (ID INTEGER NOT NULL, date_creation DATE, quantity_vendu INTEGER, REMISE FLOAT, type_paiement VARCHAR(255), PRODUCT_ID INTEGER, VENTE_ID INTEGER, SPECIFIQUE_ID INTEGER, PRIMARY KEY (ID))
