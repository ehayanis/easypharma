...
CREATE TABLE CLIENT (ID INTEGER NOT NULL, AGE INTEGER, AVS INTEGER, birth_date DATE, cover_card VARCHAR(255), EMAIL VARCHAR(255), FAX VARCHAR(255), first_name VARCHAR(255), FIX VARCHAR(255), last_name VARCHAR(255), MPI INTEGER, PHONE VARCHAR(255), REFERENCE VARCHAR(255), SEXE BOOLEAN, PRIMARY KEY (ID))
...
CREATE TABLE VENTE (ID INTEGER NOT NULL, paiement_assurance FLOAT, paiement_bvr FLOAT, paiement_carte FLOAT, paiement_cheque FLOAT, STATUS VARCHAR(255), type_vente VARCHAR(255), CLIENT_ID INTEGER, MEDECIN_ID INTEGER, OPERATOR_ID INTEGER, PRIMARY KEY (ID))
CREATE TABLE assurance_client (ID INTEGER NOT NULL, date_debut DATE, date_fin DATE, CLIENT_ID INTEGER, ASSURANCE_ID INTEGER, PRIMARY KEY (ID))
