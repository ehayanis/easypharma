...
CREATE TABLE CLIENT (ID INTEGER NOT NULL, addr_facturation VARCHAR(255), addr_livraison VARCHAR(255), addr_principal VARCHAR(255), AGE INTEGER, AVS INTEGER, birth_date DATE, cover_card VARCHAR(255), EMAIL VARCHAR(255), FAX VARCHAR(255), first_name VARCHAR(255), FIX VARCHAR(255), last_name VARCHAR(255), MPI INTEGER, PHONE VARCHAR(255), REFERENCE VARCHAR(255), SEXE BOOLEAN, PRIMARY KEY (ID))
